...
class Category(BaseModel):
    ...
    app = models.ForeignKey("applications.Application", on_delete=models.CASCADE, related_name="categories")
...
class Product(BaseModel):
    ...
    parent = models.ForeignKey(
        "self", on_delete=models.CASCADE, related_name="child_products", null=True, blank=True
    )
    ...
    app = models.ForeignKey("applications.Application", on_delete=models.CASCADE, related_name="products")
